...
Route::post('/teacher_notice/{id}',[APINoticeController::class,'update']);
Route::post('/teacher_notice/{id}',[APINoticeController::class,'delete']);
...
Route::post('/registration/{id}',[APIRegistrationController::class,'update']);
Route::post('/registration/{id}',[APIRegistrationController::class,'delete']);

// #Facs Controller

Route::get('/fac/list',[APIFacController::class,'view']);
Route::post('/fac/add', [APIFacController::class,'add']);
Route::post('/fac/{id}',[APIFacController::class,'update']);
Route::post('/fac/{id}',[APIFacController::class,'delete']);

// #finances Controller

Route::get('/finance/list',[APIfinanceController::class,'view']);
Route::post('/finance/add', [APIfinanceController::class,'add']);
Route::post('/finance/{id}',[APIfinanceController::class,'update']);
Route::post('/finance/{id}',[APIfinanceController::class,'delete']);